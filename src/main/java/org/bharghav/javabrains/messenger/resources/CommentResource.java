...
import org.bharghav.javabrains.messenger.model.Comment;
...
import org.bharghav.javabrains.messenger.service.CommentService;
...
public class CommentResource {
	...
	@GET
	@Path("/{commentId}")// here message id comes in string format but "long" in line 28 converts it to long automatically
